drop function get_report_po_approve;
...
select pwf.work_flow_id::integer as work_flow_id,
    ...
    case when pwf.acting_for is not null then concat(erp.get_program_label_name('ALL', 'PoWorkFlowOnReport', p_lin_id),' ', pwf.acting_for)
