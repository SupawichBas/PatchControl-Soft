...
BEGIN
	...
	,(select ppr.ref_doc_no from po_pr_ref ppr where ppr.pr_master_id = a.pr_master_id order by ppr.seq desc limit 1)::character varying AS ref_doc_no
	...
	left join db_list_value_lang p_List_Value_Product_Type  on p_List_Value_Product_Type.group_code = 'PoProductType' 
		...
		and lower(p_List_Value_Product_Type.language_code) = lower(lin_id)
