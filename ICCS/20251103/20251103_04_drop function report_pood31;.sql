...
BEGIN
    ...
    SELECT 
        ...
        concat('๑. รับทราบรายงานผลการพิจารณาขอบเขตของงานและราคากลางของคณะกรรมการฯดังเอกสารแนบ ๑')::character varying AS therefore_1,
        concat('๒. เห็นชอบให้ใช้ขอบเขตของงานฯ และราคากลาง เป็นเงิน ',
        		a.std_price,
				' บาท',
        		' (', erp.po_baht_text(a.std_price), ') '
        )::character varying AS therefore_2,
        concat('๓. เห็นชอบ',(SELECT 
						    CASE 
						...
						),'ตามเสนอ')::character varying AS therefore_3,
        concat('๔. อนุมัติให้ดำเนินการ',
        		a.subject,
        		' ภายใน ',
        		a.content4
        )::character varying AS therefore_4,
        concat('๕. หากเห็นชอบตามข้อ ๓. โปรดลงนามในคำสั่งแต่งตั้งคณะกรรมการตามที่แนบมาพร้อมนี้')::character varying AS therefore_5,
		CASE 
