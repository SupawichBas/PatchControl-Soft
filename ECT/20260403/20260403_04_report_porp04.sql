 DROP FUNCTION erp.report_porp04(varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, int4);
...
BEGIN
	...
	where b.company_code = p_company_code
		...
		and b.product_type  = COALESCE(p_product_type,b.product_type)
