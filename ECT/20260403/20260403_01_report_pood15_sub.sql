-- DROP FUNCTION erp.report_pood15_sub(varchar, int4);

CREATE OR REPLACE FUNCTION erp.report_pood15_sub(p_lin_id character varying, p_receive_master_id integer)
