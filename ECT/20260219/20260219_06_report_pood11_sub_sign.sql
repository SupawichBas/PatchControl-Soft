-- DROP FUNCTION erp.report_pood11_sub_sign(varchar, int4);

CREATE OR REPLACE FUNCTION erp.report_pood11_sub_sign(p_lin_id character varying, p_guaranty_master_id integer)
...
select concat('ลงชื่อ')::character varying as sign1,
		...
		concat('ผู้รับหลักประกัน')::character varying as position_name,
