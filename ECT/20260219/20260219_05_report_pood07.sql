-- DROP FUNCTION erp.report_pood07(varchar, int4);

CREATE OR REPLACE FUNCTION erp.report_pood07(p_lin_id character varying, p_pur_ord_master_id integer)
    ...
    SELECT 
        ...
        concat(
            ...
            CASE 
                ...
                ELSE ''
            END,' ',
            coalesce(a.fine_rate,0), ' ', 'ของราคางานซื้อ/เช่า แต่ต้องไม่ต่ำกว่าวันละ 100.00 บาท'
        )::character varying AS footer4,
        concat('ส่วนราชการสงวนสิทธิ์ที่จะไม่รับมอบถ้าหากปรากฏว่าสินค้านั้นมีลักษณะไม่ตรงตามรายการที่ระบุไว้ในใบสั่งเช่า กรณีนี้ผู้ขายจะต้องดำเนินการเปลี่ยนใหม่ให้ถูกต้องตามใบสั่งซื้อทุกประการ')::character varying AS footer5,
		...
		concat('การติดอากรแสตมป์ให้เป็นไปตามประมวลกฎหมายรัษฎากร หากต้องการให้ใบสั่งเช่ามีผลตามกฎหมาย')::character varying AS remake2,
        CASE 
