...
BEGIN
	...
	select a.guaranty_master_id::integer as guaranty_master_id,
			...
			erp.po_get_fromat_approve_date(a.return_req_date::date)::character varying AS fromat_approve_date
