drop function report_pood06;

CREATE OR REPLACE FUNCTION erp.report_pood06(p_lin_id character varying, p_guaranty_master_id integer)
 RETURNS TABLE(guaranty_master_id integer, company_code character varying, guaranty_no character varying, receipt_code character varying, guaranty_date character varying, ref_doc_no character varying, po_no character varying, ap_member_id integer, ap_code_name character varying, start_end_gua character varying, ref_doc_type character varying, method_name character varying, cp_date character varying, cp_subject character varying, i text, guaranty_name character varying, remark character varying, collateral_no character varying, collateral_date character varying, bank character varying, bank_branch character varying, guaranty_amt numeric, collateral_holder character varying, collateral_holder_name character varying, collateral_returnee character varying, collateral_holder_image character varying, return_emp character varying, return_emp_image character varying, cash_flag boolean, status_show_image boolean
 , ref_no character varying
 , fromat_approve_date character varying
 )
 LANGUAGE plpgsql
AS $function$
BEGIN
