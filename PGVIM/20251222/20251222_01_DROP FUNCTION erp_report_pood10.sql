...
RETURNS TABLE(
    receive_master_id integer,
    product_type character varying,
    company_code character varying,
    receive_no character varying,
    rec_place character varying,
    deliver_date character varying,
    ap_member_id integer,
    ap_member_name character varying,
    main_sub_div character varying,
    sub_div character varying,
    vat_rate character varying,
    tot_amt numeric,
    tot_vat numeric,

    receive_detail_id integer,
    seq integer,
    premium_flag boolean,
    product_name character varying,
    bill_det character varying,
    ap_det character varying,
    qty numeric,
    ums_code character varying,
    ums_name character varying,
    qty_ums_name character varying,
    unit_price numeric,
    amt numeric,
    detail_remark character varying,

    receive_set_id integer,
    set_seq integer,
    set_product_name character varying,
    set_remark character varying,
    set_brand_code character varying,
    set_model character varying,
    set_country_code character varying,
    set_product_size character varying,
    set_qty numeric,
    set_ums character varying,
    set_ums_name character varying,
    set_qty_ums_name character varying,
    set_unit_price numeric,

    baht_text character varying,
    remark_mas character varying,
    sign_image character varying,
    ...
    footer2_1 character varying,
    footer2_2 character varying,
    footer2_3 character varying,
    footer2_4 character varying,
    footer2_5 character varying,
    footer2_6 character varying,

    total_disc_amt numeric,
    total_fine_amt numeric,
    sum_tot_amt numeric,
    gs_bef_disc_master numeric,
    non_vat_amt numeric,
    ...
    approve_posi2 character varying,
    status_show_image_footer boolean,
