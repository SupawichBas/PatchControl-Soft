...
CREATE OR REPLACE FUNCTION erp.report_pood01(p_lin_id character varying, p_pr_master_id integer)
 RETURNS TABLE(pr_master_id integer,
    ...
    pr_date date,
    pr_req_date character varying,
    subject character varying,
    attn_to character varying,
    purpose character varying,
    bg_div_code character varying,
    bg_div character varying,
    budget_year integer,
    ...
    master_remark character varying,
    ...
    total_amt numeric,
    bel_amt numeric,
    recipient_image character varying,
    recipient_emp_name character varying,
    recipient_posi character varying,
    ...
    recipient_sign_image character varying,
    sign_name character varying,
    sign_posi character varying,
    personal_head_image character varying,
    personal_emp_name character varying,
    personal_posi character varying,
    pr_set_running_no integer,
    status_show_image boolean,
    status_show_head_emp_image boolean,
    status_show_pre_approve_id_level1_image boolean,
    status_show_sign_image boolean,
