...
CREATE OR REPLACE FUNCTION erp.report_pood02(p_lin_id character varying, p_pr_master_id integer)
 RETURNS TABLE(pr_master_id integer,
    ...
    div_code_display character varying,
    div_name character varying,
    div_code_name character varying,
    ref_no character varying,
    pr_no character varying,
    product_type character varying,
    product_type_name character varying,
    pr_date date,
    pr_date_day character varying,
    pr_date_month character varying,
    pr_date_year character varying,
    attn_to character varying,
    owner_id integer,
    recipient_owner_image character varying,
    owner_name character varying,
    ref_div_code character varying,
    ref_div_code_display character varying,
    ref_div_name character varying,
    ref_div_code_name character varying,
    cf_ref_div_code character varying,
    cf_ref_div_code_display character varying,
    cf_ref_div_name character varying,
    cf_ref_div_code_name character varying,
    main_div character varying,
    main_div_code_display character varying,
    main_div_name character varying,
    main_div_code_name character varying,
    budget_year integer,
    fund_code_name character varying,
    fsource_code_name character varying,
    prod_code_name character varying,
    bg_sec_code_name character varying,
    atv_code_name character varying,
    maingfmis character varying,
    gfmis character varying,
    pr_method_id integer,
    method_name character varying,
    purpose character varying,
    remark character varying,
    total_vat_amt numeric,
    total_amt numeric,
    total_non_vat numeric,
    bg_bf_amt numeric,
    bg_bal_amt numeric,
    vat_rate character varying,
    pr_detail_id integer,
    pr_set_id integer,
    baht_text character varying,
    forward_id character varying,
    bf_amt numeric,
    bel_amt numeric,
    recipient_head_image character varying,
    head_emp_name character varying,
    head_posi character varying,
    pre_approve_level1_head_image character varying,
    pre_approve_level1_emp_name character varying,
    pre_approve_posi_level1 character varying,
    recipient_approve_image character varying,
    approve_name character varying,
    approve_posi character varying,
    pr_set_running_no integer,
    surveyor_name character varying,
    surveyor_image character varying,
    ap_name character varying,
    status_show_image boolean,
    is_show_purchase boolean,
    is_show_hire boolean,
    status_show_recipient_head_image boolean,
    status_show_pre_approve_level1_head_image boolean,
    status_show_recipient_approve_image boolean,
    approve_date_head_emp_id character varying,
    approve_date_pre_approve_id_level1 character varying,
    approve_date_approve_id character varying,
    ref_doc_no character varying,
    atv_id integer,
    pr_budget_id integer,
    pr_detail_running_no integer,
    last_pr_detail_running_no integer,
    last_pr_detail_running_no_group_atv_id integer,
    group_atv_id integer)
 LANGUAGE plpgsql
AS $function$
BEGIN
    RETURN QUERY
SELECT var.*,
        ...
        COUNT(*) OVER ()::integer AS last_pr_detail_running_no,
        COUNT(*) OVER (ORDER BY var.atv_id)::integer AS last_pr_detail_running_no_group_atv_id,
