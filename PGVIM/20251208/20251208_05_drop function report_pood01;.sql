...
FROM ( select a.pr_master_id::integer AS pr_master_id,
		...
		erp.po_get_fromat_approve_date((select pwf.approve_date from po_work_flow pwf 
											...
											and pwf.approve_by_id = a.head_emp_id
                                            order by pwf.seq desc
                                            limit 1)::date)::character varying AS approve_date_head_emp_id,
		erp.po_get_fromat_approve_date((select pwf.approve_date from po_work_flow pwf 
											where pwf.company_code = a.company_code 
											and pwf.doc_type = a.doc_type 
											and pwf.doc_no = a.pr_no 
											and pwf.approve_by_id = a.pre_approve_id_level1
                                            order by pwf.seq desc
                                            limit 1)::date)::character varying AS approve_date_pre_approve_id_level1,
		erp.po_get_fromat_approve_date((select pwf.approve_date from po_work_flow pwf 
											where pwf.company_code = a.company_code 
											and pwf.doc_type = a.doc_type 
											and pwf.doc_no = a.pr_no 
											and pwf.approve_by_id = a.sign_id
                                            order by pwf.seq desc
                                            limit 1)::date)::character varying AS approve_date_sign_id,
