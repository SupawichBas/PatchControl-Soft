DROP FUNCTION erp.report_pood04_sub_detail(varchar, int4);

CREATE OR REPLACE FUNCTION erp.report_pood04_sub_detail(p_lin_id character varying, p_pur_ord_master_id integer)
