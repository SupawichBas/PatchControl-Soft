...
CREATE OR REPLACE FUNCTION erp.report_pood05_sub_detail(p_lin_id character varying, p_pur_ord_master_id integer)
 RETURNS TABLE(pur_ord_master_id integer, company_code character varying, ap_member_id integer, ap_name character varying, ap_addr character varying, ap_tel character varying, ap_fax character varying, account_number character varying, ap_bank_name character varying, bank_name character varying, bank_branch_name character varying, ref_no character varying, po_date character varying, div_name_rep character varying, div_addr_rep character varying, tel_rep character varying, fax_rep character varying, pur_ord_detail_id integer, seq integer, product_code character varying, product_name character varying, qty numeric, ums_code character varying, ums_name character varying, unit_price numeric,
  gs_aft_disc numeric,
 pur_ord_set_id integer,
 set_seq integer,
 set_product_code character varying,
 set_product_name character varying,
 set_QTY numeric,
 set_ums_code character varying,
