drop function report_pood04;

CREATE OR REPLACE FUNCTION erp.report_pood04(p_lin_id character varying, p_pur_ord_master_id integer)
...
BEGIN
	...
	select a.pur_ord_master_id::integer as pur_ord_master_id,
			...
			(case 
				when a.approve_date is not null then erp.po_get_fromat_approve_date(a.po_date::date)::character varying
				else '.............../.............../...............'
			end)::character varying AS approve_date_sign_id,
	...
	from po_pur_ord_master a
			...
			left join db_employee_name(p_lin_id) design on design.emp_id = a.sign_id
					...
					-- AND current_date BETWEEN COALESCE(po_convert_thai_to_gregorian(design.work_date), current_date)
