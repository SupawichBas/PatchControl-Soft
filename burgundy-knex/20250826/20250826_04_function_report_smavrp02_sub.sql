drop function report_smavrp02_sub;

CREATE OR REPLACE FUNCTION dbo.report_smavrp02_sub(user_company_code character varying, p_lin_id character varying, p_company_code character varying, p_branch_code character varying, p_division_code character varying, p_requester_user_code character varying, p_fix_av_doc_no character varying, p_fix_s_date character varying, p_fix_e_date character varying, p_ex_s_date character varying, p_ex_e_date character varying, user_login integer)
 RETURNS TABLE(h_company character varying, p_companybranch character varying, p_division character varying, p_emp character varying, p_document_no character varying, document_no character varying, work_flow_id integer, work_flow_type_code character varying, av_start_date character varying, av_due_date character varying, localamountofapprove numeric, ex_work_flow_id integer, ex_document_no character varying, ex_document_date date, expensetotalamount numeric, expensedocumentclearingratio numeric, expense_code character varying, expense_name character varying, accountlocalamount numeric, monthcode character varying, yearcode character varying, monthyear character varying, navigatereport character varying)
 LANGUAGE plpgsql
AS $function$ 
