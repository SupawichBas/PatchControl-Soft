...
begin
   ...
   select 
	...
	case 
		when wf.work_flow_sub_type_code = 'AVO' or wf.work_flow_sub_type_code = 'AVF'
			then (select dlvl.value_text from db_list_value_lang dlvl 
					where dlvl.company_code = wf.company_code 
	                and dlvl.group_code = 'AdvanceSubject'
	                and dlvl.value = wf.subject 
