...
FROM ( select a.pr_master_id::integer AS pr_master_id,
		...
		concat(get_report_label_name('POOD12', 'header_1', p_lin_id),' ',to_char(COALESCE(a.report_std_price, 0)::numeric, 'FM999,999,999,990.00'),' ',get_report_label_name('POOD12', 'header_1_1', p_lin_id),' (',bgst_get_baht_text(a.report_std_price),') ')::character varying AS header_1,
